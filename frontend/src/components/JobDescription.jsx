    ...
    return (
        <div className='max-w-7xl mx-10 my-10'>
            <div className='flex items-center justify-between'>
                <div>
                    ...
                    <div className='flex items-center gap-2 mt-4'>
                        ...
                        <Badge className={'text-[#F83002] font-bold'} variant="ghost">Past Time</Badge>
            ...
            <div className='my-4'>
                ...
                <h1 className='font-bold my-1'>Description: <span className='pl-4 font-normal text-gray-800'>This Job for the web Developer</span></h1>
                ...
                <h1 className='font-bold my-1'>Posted Date: <span className='pl-4 font-normal text-gray-800'>17-01-2002</span></h1>
            </div>
        </div>
    )
}
